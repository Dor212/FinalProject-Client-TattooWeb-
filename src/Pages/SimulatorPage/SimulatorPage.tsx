...
const ApplySketchPage = () => {
    ...
    console.log("👉 selectedSketch URL:", selectedSketch);
    ...
    const handleSend = async () => {
        ...
        try {
            await axios.post("http://localhost:8080/users/send-image", {
                image,
                name,
                phone,
            });
    ...
    return (
        <div className="flex flex-col items-center min-h-screen gap-6 p-6 sm:p-10 bg-[#CBB279] text-gray-800 dark:bg-gray-900 dark:text-white">
            <h1 className="text-3xl sm:text-5xl font-bold text-[#F1F3C2] text-center">
            ...
            <div className="flex flex-col w-full gap-6 lg:flex-row max-w-7xl">
                ...
                scale(${frame.scale[0]}, ${frame.scale[1]})`,
                                    ...
                                    mixBlendMode: "multiply", // ✅ אפקט קעקוע
                                    opacity: 0.6,             // ✅ שקיפות עדינה
                                    cursor: "move",
                                }}
                            />
